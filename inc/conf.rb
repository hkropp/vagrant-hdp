...
SUPPORTED_AMBARI_VERSIONS = ["1.2.1.2", "1.2.2.3", "1.2.2.4", "1.2.2.5", "1.2.3.6", "1.2.3.7", "1.2.4.9", "1.2.5.17", "1.4.1.25", "1.4.1.61", "1.4.2.104", "1.4.3.38", "1.4.4.23", "1.5.0", "1.5.1", "1.6.0", "1.6.1", "1.7.0", "2.0.0", "2.1", "2.1.1.0"]
SUPPORTED_HDP_STACKS = ["2.0", "2.0.6", "2.1", "2.2", "2.3"]
SUPPORTED_HDP_UPDATES = ["2.1.3.0","2.0.10.0","2.0.11.0","2.0.12.0","2.0.13.0","2.0.5.0","2.0.6.0","2.0.6.1","2.1.10.0","2.1.2.0","2.1.3.0","2.1.4.0","2.1.5.0","2.1.7.0","2.2.4.2","2.3.0.0"]
